...
import styles from "./ItemHiddenMenu.module.css";
const ItemHiddenMenu = (props) => {
  const { onClick, task, deleteTask, handleIsEditTask } = props;
  return (
    <div className={styles.div_items_hidden_menu}>
      {task.isHiddenMenuOpen && (
        <div className={styles.div_button_hidden_menu}>
          <Button
